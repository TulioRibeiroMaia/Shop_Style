...
import shop.style.checkout.Controller.PaymentController;
import shop.style.checkout.DTO.Form.PaymentFormDTO;
import shop.style.checkout.Enums.PaymentType;
import shop.style.checkout.Service.Impl.PaymentServiceImpl;
...
public class PaymentControllerTest {
    ...
    @Test
    @DisplayName("Não deveria listar um pagamento com o ID informado e retornar status BAD_REQUEST")
